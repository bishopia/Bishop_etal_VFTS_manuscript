...
#setwd
setwd("C:/Users/ibishop/OneDrive - DOI/science/gc_metabolism/eda_twostation/mv60/")
...
load("./leesextended_2023_modeloutput_mv60_20250506_payndates.RData")

#choose and name model
model <- ms_prior
model_name <- "mv60_payndates_B3"
