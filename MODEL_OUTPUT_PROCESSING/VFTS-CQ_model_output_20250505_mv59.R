...
#setwd
setwd("C:/Users/ibishop/OneDrive - DOI/science/gc_metabolism/eda_twostation/mv59/")
...
load("./leesextended_2023_modeloutput_mv59_20250505_payndates.RData")

#choose and name model
model <- ms_prior
model_name <- "mv59_payndates_B2"
...
# ggsave(paste0("./graphics/rhat_histograms_", model_name, ".png"), Rhat_hist, width=2*3.25, height=2*3.25, units="in")
...
###---export input csv file
df_subdaily %>% select(jul, datetime, DO_obs_down, DO_obs_up, DO_sat_down, DO_sat_up, temp, lag, tt) %>%
  write_csv("./mv59_input_for_data_release.csv")
